...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("image_url_test.log"),
        logging.StreamHandler()
    ]
)
logger = logging.getLogger("ImageURLTest")

def test_image_url_preservation():
    """测试图片URL保留功能"""
    ...
    test_cases = [
        {
            ...
            "expected_contains": ["https://course.yangcong345.com/pdc/9e532d1a-cd06-45d8-ac38-a59bd497def8.png"]
        },
        {
            "name": "纯文本答案",
...
def test_real_world_examples():
    ...
    real_examples = [
        ...
        },
        {
            ...
            "expected_contains": ["https://course.yangcong345.com/pdc/426770f7-3e4c-400f-9fd7-4d89dde1ff83.png"]
        }
    ]
...
if __name__ == "__main__":
    logger.info("开始测试图片URL保留功能")
    test_image_url_preservation()
